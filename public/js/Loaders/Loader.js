        ...
        switch (file.type)
        {
            ...
            case 'audio':
                ...
                if (file.url !== null)
                {
					...
					/** If this is Apache Cordova and the Media plugin is loaded */
					else if(this.game.device.cordova && typeof Media !== "undefined")
					{
						file.data = new Media(this.baseURL + file.url);
						file.data.name = file.key;
                        file.data.preload = 'auto';
                        file.data.src = this.baseURL + file.url;
                        this.fileComplete(this._fileIndex);
